...
|                                          | **Other Cordova enhancements**:  <li>Send HTTP requests to APIs hosted on public servers</li><li>Start SDK with the msso_config.json file from a URL.</li><li>Sign claims with keys to generate a Java Web Token.</li> | Cordova      |        | 
