...
| :--------------------------------------- | ---------------------------------------- | ---------------------------------------- |
| DE388462                                 | The Mobile SDK supports special characters in email addresses per the RFC for email addresses. However, the MAG and OTK do not support these characters: &  \| | None.                                    |
