...
| Web browser authentication               | CA Mobile SDK 1.6 now provides browser-based login page using Chrome Custom Tabs (Android) or Safari View Controller (iOS) giving you the flexibility to choose between a native, or browser-based login page. If you have a suite of mobile applications, browser-based login lets you dynamically change the login template of all the apps without modifying them individually. Using a browser-based login flow, the user is directed to a customized login page for user authentication. <br>**Requires**: Mobile Developer Console, version 1.1.0</br>                                     | Cordova      | <link> |
