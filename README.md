...
| :--------------------------------------- | ---------------------------------------- | ---------------------------------------- |
| DE388462                                 | Device registration fails with error `java.io.IOException: Incorrect AVA format` when user logs in using email with specific special characters. | Although the Mobile SDK supports the following characters in email addresses,  `!,#,$,%,&,',*,+,-,/,=,?,^,_,{,|,},~` the following characters are not supported: `&,|` |
