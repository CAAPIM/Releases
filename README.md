...
| Web browser authentication               | CA Mobile SDK 1.6 now provides browser-based login page via Chrome Custom Tabs (Android) or Safari View Controller (iOS) giving the app developer flexibility to choose between native, or browser- based login page. If you have suite of mobile applications, browser-based login lets you dynamically change the login template of all the apps without modifying them individually. Using browser-based login flow, user is directed to customized login page for user authentication.                                      | Cordova      | <link> |
