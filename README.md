...
| Social Login (all Mobile SDKs)     | Social Login is not supported when MAS services are installed. The Mobile SDK authenticates only against a supported IDP using the User Management component. | (Admin) Policy customization is required. |
